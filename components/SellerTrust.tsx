 ...
 *
 * Vive donde se decide la compra; la ficha completa está más abajo en
 * `SellerReputation`. Aquí caben tres datos y no más.
 */
...
export default function SellerTrust({ seller }: { seller: SellerStats }) {
  return (
    <a
      href="#reputacion-titulo"
      className="seller-trust"
    ...
    >
      ...
      <div style={{ minWidth: 0 }}>
        <div style={{ fontSize: 13, fontWeight: 500 }}>{seller.medal}</div>

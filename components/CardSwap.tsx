...
export const CardSwapCard = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...rest }, ref) => (
    <div ref={ref} {...rest} className={`card-swap-item ${className ?? ''}`.trim()} />
  )
);
...
export default function CardSwap({
  ...
  return (
    <div ref={containerRef} className={`card-swap-container ${className}`} style={{ width, height }}>
      {rendered}
    </div>
  );
}

...
export const CATALOG: Product[] = [
  ...
  },
  {
    ...
    colors: [{ name: 'Rojo cereza', hex: '#c4302c' }],
  ...
  },
  {
    ...
    colors: [{ name: 'Valencia estándar', hex: '#e07e1f' }],
    sizes: ['Bolsa 5L', 'Bolsa 10L'],
    accent: 'orange',
  ...
  },
  {
    ...
    colors: [{ name: 'Arrayana criolla', hex: '#d65a2a' }],
    sizes: ['Bolsa 5L', 'Bolsa 10L'],
    accent: 'orange',
  ...
  },
  {
    ...
    description: 'Rubus glaucus. Variedad mejorada sin espinas con racimos largos de frutos grandes. Cultivada en zonas de clima frío entre los 1.800 y 3.000 msnm.',
    colors: [
  ...
  },
  {
    ...
    description: 'Fragaria × ananassa var. Albión. Plántulas certificadas de día neutro: producen todo el año. Ideal para huertas urbanas y mesas hidropónicas.',
    colors: [
  ...
  // ============ ORNAMENTALES ============
  {
    ...
    description: 'Inflorescencia péndula de colores escarlata y amarillo. Planta tropical icónica del paisajismo colombiano. Atrae colibríes.',
    colors: [
  ...
  },
  {
    ...
    description: 'Anthurium andreanum. Espata brillante que dura semanas en pie. Cultivado en condiciones controladas de sombra y humedad.',
    colors: [
  ...
  },
  {
    ...
    description: 'Vriesea splendens. Bromelia epífita con hojas listadas e inflorescencia roja que dura meses. Ideal para interiores luminosos.',
    colors: [
  ...
  // ============ SUCULENTAS ============
  {
    ...
    description: 'Echeveria elegans. Roseta compacta de hojas carnosas color verde azulado con bordes rosados. Especie estrella del coleccionismo. Reproducción muy fácil.',
    colors: [
  ...
  },
  {
    ...
    description: 'Sedum morganianum. Tallos colgantes formados por pequeñas hojas en forma de gota color verde jade. Perfecta para macetas colgantes.',
    colors: [{ name: 'Jade', hex: '#8aaa6a' }],
  ...
  },
  {
    ...
    description: 'Haworthia cooperi. Suculenta sudafricana con hojas casi transparentes. Tolerante a la sombra. Perfecta para escritorios.',
    colors: [
  ...
  // ============ SEMILLAS ============
  {
    ...
    description: 'Coffea arabica var. Castillo. La variedad insignia colombiana, resistente a la roya. Sobre de 500 semillas seleccionadas. Germinación garantizada superior al 85%.',
    colors: [
  ...
  },
  {
    ...
    description: 'Theobroma cacao CCN-51 e ICS-95. Semillas de árboles madres certificados. Alto rendimiento adaptadas al trópico húmedo colombiano.',
    colors: [
  ...
  // ============ SUSTRATOS ============
  {
    ...
    description: 'Fibra de coco lavada y compactada en bloques expandibles. Excelente retención de humedad y drenaje. Ideal para semilleros, suculentas y cultivos hidropónicos.',
    colors: [
...
export function getCrossSellProducts(product: Product): Product[] {
  const crossMap: Record<string, string[]> = {
    ...
    suculentas: ['sustratos'],
    semillas: ['fertilizantes', 'sustratos'],
    ornamentales: ['fertilizantes'],
